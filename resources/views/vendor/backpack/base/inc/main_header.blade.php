<header class="{{ config('backpack.base.header_class') }}">
  ...
  <a style="opacity: unset;" class="navbar-brand" href="{{ url(config('backpack.base.home_link')) }}" title="{{ config('backpack.base.project_name') }}">

     <img  src="{{ asset('/logo.ico') }}" alt="Logo" style="max-height: 40px;">
